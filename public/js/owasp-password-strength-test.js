      ...
      required: [
        ...
        function(password) {
          if (password.length < owasp.configs.minLength) {
            return '암호는 적어도 ' + owasp.configs.minLength + '자 이상 이여야합니다.';
          }
        },
        ...
        function(password) {
          if (password.length > owasp.configs.maxLength) {
            return '암호는 ' + owasp.configs.maxLength + '자 이내 이여야합니다.';
          }
        },
        ...
        function(password) {
          if (/(.)\1{2,}/.test(password)) {
            return '암호에 3자이상의 반복되는 문자가 포함되어있습니다.';
          }
        },
      ...
      optional: [
        ...
        function(password) {
          if (!/[a-z]/.test(password)) {
            return '암호는 적어도 하나의 소문자를 포함해야합니다.';
          }
        },
        ...
        // function(password) {
        //   if (!/[A-Z]/.test(password)) {
        //     return '암호는 적어도 하나의 대문자를 포함해야합니다.';
        //   }
        // },
        ...
        function(password) {
          if (!/[0-9]/.test(password)) {
            return '암호는 적어도 하나의 숫자를 포함해야합니다.';
          }
        },
